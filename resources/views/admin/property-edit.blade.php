                            ...
                            <div class="row">
                                <div class="col-12"><br>
                                    <div class="card card-default">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" id="property_add" enctype="multipart/form-data" action="{{ route('admin.property.update', ['id' => $property->id]) }}"   />
                                                <div class="row">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="col-md-4 mt-3 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required class="form-control"
                                                                ...
                                                                placeholder="Property Code" value="{{$property->prop_code}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mt-3 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required class="form-control"
                                                                ...
                                                                placeholder="Property Name" value="{{$property->prop_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mt-3 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" required class="form-control"
                                                                ...
                                                                placeholder="Property Image" value="{{$property->prop_image}}">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        <label for="city_id">Select City</label>
                                                        <select name="city_id" class="form-select" id="city_id" value="{{$property->city_id}}">
                                                    ...
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="development_id" class="form-select" id="development_id" value="{{$property->development_id}}">
                                                            <option value="1">One</option>
                                                            <option value="2">Two</option>
                                                            <option value="3">Three</option>
                                                        </select>
                                                    ...
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="developer_id" class="form-select" id="developer_id" value="{{$property->developer_id}}">
                                                            <option value="1">One</option>
                                                            <option value="2">Two</option>
                                                            <option value="3">Three</option>
                                                        </select>
                                                    ...
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="prop_type" class="form-select" id="prop_type">
                                                            <option value="Condo" @if($property->prop_type == 'Condo') selected @endif>Condo</option>
                                                            <option value="Townhouse" @if($property->prop_type == 'Townhouse') selected @endif>Townhouse</option>
                                                            <option value="Condo-Townhomes" @if($property->prop_type == 'Condo-Townhomes') selected @endif>Condo Townhomes</option>
                                                            <option value="Single-family" @if($property->prop_type == 'Single-family') selected @endif>Single family</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="prop_status" class="form-select"
                                                            id="prop_status">
                                                            <option value="Pre-Construction"  @if($property->prop_status == 'Pre-Construction') selected @endif>Pre-Construction</option>
                                                            <option value="Under-Construction"  @if($property->prop_status == 'Under-Construction') selected @endif>Under-Construction
                                                            </option>
                                                    ...
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="0" required
                                                                ...
                                                                name="no_of_stories" placeholder="No Of Stories" value="{{$property->no_of_stories}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="0" required
                                                                ...
                                                                name="no_of_suites" placeholder="No Of Suites" value="{{$property->no_of_suites}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                placeholder="Estimate Occupency Month" value="{{$property->est_occupancy_month}}">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="est_occupancy_year" class="form-select"
                                                            ...
                                                            <option value="2022" @if($property->est_occupancy_year == '2022') selected @endif>2022</option>
                                                            <option value="2023" @if($property->est_occupancy_year == '2023') selected @endif>2023</option>
                                                            <option value="2024" @if($property->est_occupancy_year == '2024') selected @endif>2024</option>
                                                            <option value="2025" @if($property->est_occupancy_year == '2025') selected @endif>2025</option>
                                                            <option value="2026" @if($property->est_occupancy_year == '2026') selected @endif>2026</option>
                                                            <option value="2027" @if($property->est_occupancy_year == '2027') selected @endif>2027</option>
                                                            <option value="2028" @if($property->est_occupancy_year == '2028') selected @endif>2028</option>
                                                            <option value="2029" @if($property->est_occupancy_year == '2029') selected @endif>2029</option>
                                                            <option value="2030" @if($property->est_occupancy_year == '2030') selected @endif>2030</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" required value="2020-01-01"
                                                                ...
                                                                type="date" placeholder="Vip launch Date" value="{{$property->vip_launch_date}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="2020-01-01"
                                                                ...
                                                                placeholder="Public launch Date" value="{{$property->public_launch_date}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="2020-01-01"
                                                                ...
                                                                type="date" placeholder="Construction Start Date" value="{{$property->const_start_date}}">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="is_hot" class="form-select" id="hot_property"
                                                            ...
                                                            <option value="1" @if($property->is_hot == '1') selected @endif>Yes</option>
                                                            <option value="0" @if($property->is_hot == '0') selected @endif>No</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        <label
                                                        ...
                                                        <select class="form-select" name="vip_featured_promotion"
                                                            ...
                                                            <option value="Vip" @if($property->vip_featured_promotion == 'Vip') selected @endif>Vip</option>
                                                            <option value="Featured" @if($property->vip_featured_promotion == 'Featured') selected @endif>Featured</option>
                                                            <option value="Promotion" @if($property->vip_featured_promotion == 'Promotion') selected @endif>Promotion</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="sale_rent" required id="sale_rent"
                                                            class="form-select">
                                                            <option value="Sale" @if($property->sale_rent == 'Sale') selected @endif>Sale</option>
                                                            <option value="Rent" @if($property->sale_rent == 'Rent') selected @endif>Rent</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="sold_out" required id="sold_out"
                                                            class="form-select">
                                                            <option value="1" @if($property->sold_out == 1) selected @endif>Yes</option>
                                                            <option value="0" @if($property->sold_out == 0) selected @endif>No</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 mt-3 col-md-4">
                                                        ...
                                                        <select name="status" required id="status"
                                                            ...
                                                            <option value="0" @if($property->status == 0) selected @endif>In Active</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                placeholder="Suites Starting Floor" value="{{$property->suites_starting_floor}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                placeholder="Suites Per Floor" value="{{$property->suites_per_floor}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                name="floor_plans" placeholder="Floor Plans" value="{{$property->floor_plans}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                placeholder="Property Price From" value="{{$property->prop_price_from}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                name="prop_price_to" placeholder="Property Price To" value="{{$property->prop_price_to}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                name="suite_size_from" placeholder="Suite Size From" value="{{$property->suite_size_from}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                name="suite_size_to" placeholder="Suite Size To" value="{{$property->suite_size_to}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                name="ceiling_height" placeholder="Ceiling Height" value="{{$property->ceiling_height}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                placeholder="Price Per Sq/ft From" value="{{$property->price_per_sqft_from}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                placeholder="Price Per Sq/ft To" value="{{$property->price_per_sqft_to}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                name="parking_price" placeholder="Parking Price" value="{{$property->parking_price}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required value="0"
                                                                ...
                                                                name="locker_price" placeholder="Locker Price" value="{{$property->locker_price}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                placeholder="Min Deposit Percentage" value="{{$property->min_deposit_percentage}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 mb-3 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required class="form-control"
                                                                ...
                                                                placeholder="Property Address" value="{{$property->prop_address}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 mb-3 mt-3">
                                                        <div class="form-group">
